      ...
      >
        ...
        <th scope="row" className="bench-arm__h">
          ...
          <span className="bench-arm__who">
            <a className="bench-sys" href={`${baseUrl}systems/${row.entrant}`}>
              {name}
            </a>
        ...
        <td colSpan={colSpan}>
          <div className="bench-detail__box">
              ...
              <dd>
                {v?.binding_constraint ?? (
                  <span className="bench-note">
                    ...
                    <a href={`${baseUrl}contract/rules`}>the fairness contract</a> requires
            ...
            <p className="bench-note">
              <a href={`${baseUrl}systems/${row.entrant}`}>
